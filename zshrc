...
# Not sure why this won't work. Tried so far:
# - fpath directory created and set correctly
# - permissions checked
# - ZSH_DISABLE_COMPFIX=true to mask insecure directories, 
# - zcompdump file manually created
